    ...
    return themeConfigAsync.when(
      ...
      data: (themeConfig) {
        return appConfigAsync.when(
          ...
          error: (e, st) => Scaffold(
            body: Center(child: Text('加载应用配置失败: $e')),
          ),
          data: (appConfig) => _buildIndexScreen(themeConfig, appConfig, isDarkMode),
        );
      },
    );
  }

  Widget _buildIndexScreen(ThemeConfig themeConfig, AppConfig appConfig, bool isDarkMode) {
    // 使用响应式的当前主题
    final selectedTheme = ref.watch(selectedCustomThemeProvider);
    final boxBlur = selectedTheme?.indexMessageBoxBlur ?? false;
                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        if (appConfig.showClassroom) const SizedBox(height: 16),
                        ...
                        if (appConfig.showTodo) ...[
                          ...
                          Container(
                            ...
                            child: Text(
                              'TodoBrief被隐藏: showTodo = ${appConfig.showTodo}',
