...
class ExpenseBrief extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    // 添加状态安全检查
    debugPrint('ExpenseBrief build: isBound=${expenseState.isBound}, isLoading=${expenseState.isLoading}, hasData=${expenseBrief != null}');
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Text(
                      ...
                      style: TextStyle(
                        color: expenseBrief.isIncrease ? Colors.red : Colors.green,
                        fontSize: 12,
                        fontWeight: FontWeight.w500,
                      ),
                    ),
