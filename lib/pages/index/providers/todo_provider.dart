...
class TodoNotifier extends StateNotifier<List<TodoItem>> {
  ...
  Future<void> _loadTodos() async {
    try {
      ...
      final todos = todoData.map((item) => TodoItem.fromJson(item as Map<String, dynamic>)).toList();
    ...
    try {
      ...
      if (response['success'] == true) {
        ...
        if (response['data'] != null) {
          createdTodo = TodoItem.fromJson(response['data'] as Map<String, dynamic>);
